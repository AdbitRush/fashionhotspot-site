...
UI_EXTRA = {
    "en": {"latest": "Latest guide", "recently_updated": "Recently updated",
           ...
           "grp_gifts": "Gifts", "grp_seasonal": "Seasonal",
           "search_label": "Search guides", "search_placeholder": "Search guides…",
           "search_clear": "Clear search", "filter_group_label": "Filter by category",
           "topics_label": "Filter by topic", "topic_all": "All {grp}",
           "count_of_total": "{n} of {total} guides", "show_all": "Show all {n} {grp} guides",
           "empty_message": "No guides match “{q}”", "empty_clear": "Clear",
    ...
    "he": {"latest": "המדריך האחרון", "recently_updated": "עודכנו לאחרונה",
           ...
           "grp_gifts": "מתנות", "grp_seasonal": "עונתי",
           "search_label": "חיפוש מדריכים", "search_placeholder": "חיפוש מדריכים…",
           "search_clear": "ניקוי חיפוש", "filter_group_label": "סינון לפי קטגוריה",
           "topics_label": "סינון לפי נושא", "topic_all": "כל {grp}",
           "count_of_total": "{n} מתוך {total} מדריכים", "show_all": "הצגת כל {n} מדריכי {grp}",
           "empty_message": "אין מדריכים התואמים ל־“{q}”", "empty_clear": "ניקוי",
           "view_grid": "רשת", "view_list": "רשימה"},
    "es": {"latest": "Guía más reciente", "recently_updated": "Actualizadas hace poco",
           ...
           "grp_gifts": "Regalos", "grp_seasonal": "De temporada",
           "search_label": "Buscar guías", "search_placeholder": "Buscar guías…",
           "search_clear": "Borrar búsqueda", "filter_group_label": "Filtrar por categoría",
           "topics_label": "Filtrar por tema", "topic_all": "Todo {grp}",
           "count_of_total": "{n} de {total} guías", "show_all": "Ver las {n} guías de {grp}",
           "empty_message": "Ninguna guía coincide con “{q}”", "empty_clear": "Borrar",
    ...
    "fr": {"latest": "Dernier guide", "recently_updated": "Mis à jour récemment",
           ...
           "grp_gifts": "Cadeaux", "grp_seasonal": "De saison",
           "search_label": "Rechercher des guides", "search_placeholder": "Rechercher des guides…",
           "search_clear": "Effacer la recherche", "filter_group_label": "Filtrer par catégorie",
           "topics_label": "Filtrer par thème", "topic_all": "Tout {grp}",
           "count_of_total": "{n} sur {total} guides", "show_all": "Voir les {n} guides {grp}",
           "empty_message": "Aucun guide ne correspond à « {q} »", "empty_clear": "Effacer",
    ...
    "de": {"latest": "Neuester Ratgeber", "recently_updated": "Kürzlich aktualisiert",
           ...
           "grp_gifts": "Geschenke", "grp_seasonal": "Saisonal",
           "search_label": "Ratgeber durchsuchen", "search_placeholder": "Ratgeber durchsuchen…",
           "search_clear": "Suche löschen", "filter_group_label": "Nach Kategorie filtern",
           "topics_label": "Nach Thema filtern", "topic_all": "Alle {grp}",
           "count_of_total": "{n} von {total} Ratgebern", "show_all": "Alle {n} {grp}-Ratgeber anzeigen",
           "empty_message": "Keine Ratgeber passen zu „{q}“", "empty_clear": "Löschen",
    ...
    "el": {"latest": "Πιο πρόσφατος οδηγός", "recently_updated": "Ενημερώθηκαν πρόσφατα",
           ...
           "grp_gifts": "Δώρα", "grp_seasonal": "Εποχιακά",
           "search_label": "Αναζήτηση οδηγών", "search_placeholder": "Αναζήτηση οδηγών…",
           "search_clear": "Καθαρισμός αναζήτησης", "filter_group_label": "Φιλτράρισμα κατά κατηγορία",
           "topics_label": "Φιλτράρισμα κατά θέμα", "topic_all": "Όλα τα {grp}",
